...
let opBusinessLicenseConfirm = (claim_sn) => {
  ...
  let isPersonCheck = value.isPersonCheck
  // console.log('value', value)
  // 是否父签名
  if (value.isPdidCheck === null) {
  ...
  if (value.isPersonCheck === false) {
    let delResult = tokenSDKServer.delPendingTaskItem(claim_sn)
  }
  if (value.isPersonCheck === true && value.isPdidCheck) {
  // if (true) { // 测试用
    // 签名
